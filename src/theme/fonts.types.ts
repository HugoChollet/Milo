...
export type ParagraphFontType = 'regular' | 'italic' | 'bold';
...
export type ParagraphFonts = {
  /**
   ** fontSize: 16
   ** lineHeight: 24
   */
  p1: Record<ParagraphFontType, FontStyle>;
  /**
   ** fontSize: 14
   ** lineHeight: 21
   */
  p2: Record<ParagraphFontType, FontStyle>;
  /**
   ** fontSize: 12
   ** lineHeight: 18
   */
  p3: Record<ParagraphFontType, FontStyle>;
};
